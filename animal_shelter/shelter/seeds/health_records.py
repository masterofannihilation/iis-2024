...
HEALTH_RECORD_SEEDS = (
    ...
    VeterinarianRequest(
        ...
        status=VeterinarianRequest.Status.COMPLETED,
        examination_date=datetime.datetime(2023, 6, 10, 9, 0, tzinfo=pytz.UTC),
        result="Spayed, recovery successful.",
        description="Spay surgery, recovery monitored.",
    ),
    VeterinarianRequest(
        id=1_003_007,
        animal_id=1_002_007,
    ...
    VeterinarianRequest(
        ...
        status=VeterinarianRequest.Status.COMPLETED,
        examination_date=datetime.datetime(2023, 7, 15, 8, 0, tzinfo=pytz.UTC),
        result="Skin rash, prescribed medication.",
